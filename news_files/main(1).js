...
function animate1(){
    ...
    tl.to(["#whiteFader"], .25, {autoAlpha:1,force3D:true, ease:Power1.easeOut, delay:2.5});

    tl.to(["#bg2","#branding","#c1"], transitionSpeed, {autoAlpha:1,force3D:true, ease:Power1.easeIn}, "-=0");

    //tl.to(["#branding"], transitionSpeed, {autoAlpha:1,force3D:true, ease:Power1.easeIn}, "-=0");

   // tl.to(["#c1"], transitionSpeed, {autoAlpha:1,force3D:true, ease:easing, delay:.5});
   ...
   // tl.to(["#c3", "#arrow"], transitionSpeed, {autoAlpha:1,force3D:true, ease:easing, delay:.5});
